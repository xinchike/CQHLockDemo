//
//  CQHLockPerformanceViewController.m
//  LockDemo
//
...
#import "CQHLockPerformanceViewController.h"
#import <pthread.h>
...
@interface CQHLockPerformanceViewController ()

@end

@implementation CQHLockPerformanceViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.title = @"LockPerformance";
